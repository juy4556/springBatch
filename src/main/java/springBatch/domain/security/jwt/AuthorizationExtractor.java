...
public class AuthorizationExtractor {
    ...
    private static String checkValueStartsWithBearer(HttpServletRequest request, String value) {
    ...
    private static String updateAuthHeaderValue(String authHeaderValue, int commaIndex) {
        if (commaIndex > 0) {
